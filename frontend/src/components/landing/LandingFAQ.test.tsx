...
const copy: Record<string, string> = {
    ...
    "landing.faqFreeAnswer": "Yes. The Basic plan includes 3 videos each month and does not require a card.",
    ...
    "landing.faqBillingAnswer": "Pro is $99 per year with a 12-month commitment.",
