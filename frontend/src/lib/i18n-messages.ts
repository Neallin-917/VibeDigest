...
export const messages: Record<Locale, Messages> = {
  en: {
    ...
    landing: {
      titlePrefix: "Turn one link into a",
      titleEmphasis: "digest you can use.",
      previewKicker: "A finished VibeDigest",
      previewTitle: "State of the Claw — Peter Steinberger",
      previewReady: "Ready to read",
      ...
      previewOpen: "Open a finished digest",
      subtitle:
      ...
      smartSummarizationDesc: "Turn long videos and podcasts into structured summaries, transcripts, and key takeaways you can revisit.",
      ...
      step2Desc: "VibeDigest transcribes the content and extracts its key ideas.",
      step3Title: "3. Get Summary",
      step3Desc: "Receive a structured summary, transcript, and key takeaways.",
      ...
      communityTitle: "See a finished digest",
      communityHint: "Curated public demos. Your own tasks stay private.",
  ...
  zh: {
    ...
    landing: {
      titlePrefix: "一个链接，变成一份",
      titleEmphasis: "可继续使用的摘要。",
      previewKicker: "一份已完成的 VibeDigest",
      previewTitle: "State of the Claw — Peter Steinberger",
      previewReady: "已可阅读",
      ...
      smartSummarizationDesc: "把长视频和播客整理成结构化摘要、逐字稿与理解要点，方便随时回顾。",
      ...
      step2Title: "2. AI 处理",
      step2Desc: "VibeDigest 转写内容，并提取其中的核心观点。",
      step3Title: "3. 获取摘要",
      step3Desc: "获得结构化摘要、逐字稿和理解要点。",
      simplePricing: "简单定价",
      ...
      communityTitle: "查看已完成的摘要",
      communityHint: "精选公开示例；你的任务默认保持私密。",
  ...
  ja: {
    ...
    landing: {
      titlePrefix: "ひとつのリンクを、",
      titleEmphasis: "使える要約へ。",
      previewKicker: "完成した VibeDigest",
      previewTitle: "State of the Claw — Peter Steinberger",
      previewReady: "閲覧可能",
      ...
      smartSummarizationDesc: "長い動画やポッドキャストを、後から見返しやすい要約、文字起こし、重要ポイントに整理します。",
      ...
      step2Title: "2. AI処理",
      step2Desc: "VibeDigestが内容を文字起こしし、重要なポイントを抽出します。",
      step3Title: "3. 要約を取得",
      step3Desc: "構造化された要約、文字起こし、重要ポイントを受け取ります。",
