...
const enMessages = {
    ...
    landing: {
      ...
      simplePricing: "Start free. Go further when you need to.",
      ...
      communityTitle: "Explore the podcast library",
      ...
      featureReadTitle: "Get the key ideas",
      featureReadDescription: "Read the summary and key ideas from a long video.",
      featureVerifyTitle: "Check the source",
      featureVerifyDescription: "Use supporting evidence and source links to check your understanding.",
      featureAskTitle: "Ask a follow-up",
      featureAskDescription: "Go deeper with answers grounded in the episode.",
      ...
      proAnnualBilling: "{annualPrice} billed annually.",
      ...
      faqSignInAnswer: "Paste your link, then sign in to start processing. Your link will be saved.",
...
const zhMessages: MessageShape<typeof enMessages> = {
    ...
    landing: {
      ...
      featureReadTitle: "快速读懂",
      featureReadDescription: "提炼长视频的摘要和关键观点。",
      featureVerifyTitle: "回到原内容",
      featureVerifyDescription: "结合证据和来源核对理解。",
      featureAskTitle: "继续追问",
      featureAskDescription: "围绕这期内容深入提问。",
      ...
      faqSignInAnswer: "先粘贴链接，登录后即可开始处理，链接会保留。",
