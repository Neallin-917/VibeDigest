...
export const messages: Record<Locale, Messages> = {
  en: {
    ...
    landing: {
      ...
      smartSummarizationDesc: "Paste a link. VibeDigest turns it into a summary, key ideas, transcript, and answers grounded in the source.",
      dynamicTemplates: "Dynamic Podcast Templates",
      dynamicTemplatesDesc: "Read in formats that fit the content, from debate matrices to narrative arcs, so complex podcasts are easier to follow.",
      ...
      step1Title: "1. Paste a link",
      step1Desc: "Add a supported podcast or video URL.",
      step2Title: "2. Let the agent organize it",
      step2Desc: "VibeDigest transcribes the source and structures its summary and key ideas.",
      step3Title: "3. Read and follow up",
      step3Desc: "Read the digest, open the transcript, or ask questions grounded in the source.",
  ...
  zh: {
    ...
    landing: {
      ...
      smartSummarizationDesc: "粘贴一个链接，VibeDigest 会整理摘要、关键观点和逐字稿，并基于原内容回答后续问题。",
      dynamicTemplates: "动态播客模板",
      dynamicTemplatesDesc: "针对不同播客类型提供定制化视图，从激烈辩论到深度叙事都更易理解。",
      ...
      step2Title: "2. 让 Agent 整理",
      step2Desc: "VibeDigest 转写原内容，并组织摘要与关键观点。",
      step3Title: "3. 阅读并继续追问",
      step3Desc: "阅读整理结果、查看逐字稿，或基于原内容继续提问。",
      simplePricing: "简单定价",
  ...
  ja: {
    ...
    landing: {
      ...
      smartSummarizationDesc: "リンクを貼ると、VibeDigestが要約、重要ポイント、文字起こしを整理し、元の内容に基づいて質問に答えます。",
      dynamicTemplates: "コンテンツ別テンプレート",
      dynamicTemplatesDesc: "対談、議論、解説など、内容に合った読みやすい形式でポイントを整理します。",
      ...
      mobileFirst: "モバイル最適化",
      mobileFirstDesc: "スマートフォンでも、要約、文字起こし、チャットを快適に確認できます。",
      ...
      step2Title: "2. Agentに整理を任せる",
      step2Desc: "VibeDigestが文字起こしを行い、要約と重要ポイントを構成します。",
      step3Title: "3. 読んで続けて質問する",
      step3Desc: "整理結果や文字起こしを読み、元の内容に基づいて質問できます。",
      ...
      footerCopyright: "© {year} VibeDigest. All rights reserved.",
      comingSoon: "近日公開",
      featuresTitlePrefix: "動画から",
      featuresTitleEmphasis: "もっと速く学ぶ",
      featuresSubtitle: "要約、文字起こし、チャットで、視聴を理解につなげます。",
      mostPopular: "おすすめ",
