...
export const messages: Record<Locale, Messages> = {
  en: {
    ...
    auth: {
      ...
      handoffMessageReady: "Your request is saved",
      ...
      handoffSource: "Recognized source",
  ...
  ja: {
    ...
    auth: {
      ...
      handoffMessageReady: "リクエストを保存しました",
