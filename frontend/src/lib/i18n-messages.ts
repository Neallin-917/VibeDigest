...
export const messages: Record<Locale, Messages> = {
  en: {
    ...
    landing: {
      ...
      previewKicker: "VibeDigest Agent output",
      previewSectionLabel: "Agent digest",
      previewSourceMap: "Source map",
      previewTitle: "State of the Claw: Peter Steinberger",
      previewReady: "Ready to explore",
      previewBriefLabel: "Brief",
      ...
      previewAnswer: "Ask a natural-language follow-up and keep the answer tied to the source material.",
  ...
  zh: {
    ...
    landing: {
      titlePrefix: "让 AI 帮你",
      titleEmphasis: "看完播客。",
      previewKicker: "VibeDigest Agent 输出",
      previewSectionLabel: "Agent 整理结果",
      previewSourceMap: "来源脉络",
      previewTitle: "State of the Claw: Peter Steinberger",
      previewReady: "可以体验",
      previewBriefLabel: "摘要",
      ...
      previewAnswer: "自然语言追问会持续关联到原始内容，而不是脱离来源的泛泛回答。",
  ...
  ja: {
    ...
    landing: {
      ...
      previewKicker: "VibeDigest Agent の出力",
      previewSectionLabel: "Agent の整理結果",
      previewSourceMap: "情報源マップ",
      previewTitle: "State of the Claw: Peter Steinberger",
      previewReady: "すぐに体験",
      previewBriefLabel: "概要",
      ...
      previewAnswer: "自然言語で続けて質問しても、回答は元のコンテンツと結び付き続けます。",
